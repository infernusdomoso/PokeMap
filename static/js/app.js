;(function () {
  ...
  var $captchaToggle = document.querySelector('a[href="#captcha"]')
  var $statsClose
  var $captchaClose
  console.log("sss");
  ...
  addEventsListener($body, 'click touchend', function (event) {
    ...
    if ($captcha && event.target.matches('a[href="#captcha"]')) {
      return
    }
  ...
  if ($captchaToggle) {
    $captchaToggle.addEventListener('click', function (event) {
      event.preventDefault()
      event.stopPropagation()
      $captcha.classList.toggle('visible')
    })
  }
